                ...
                <div class="lg:col-span-1">
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 sticky top-6">
                        <h3 class="text-lg font-bold text-gray-900 mb-4 border-b pb-2">
                            {{ $isEditing ? '✏️ Edit Expense' : 'Log New Expense' }}
                        </h3>
                        
                        <form wire:submit="save" class="space-y-4">
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-1">Title / Vendor</label>
                                <input type="text" wire:model="title" placeholder="e.g. March Electricity Bill" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            ...
                            <div>
                                ...
                                <input type="date" wire:model="expense_date" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                @error('expense_date') <span class="text-red-500 text-xs font-bold">{{ $message }}</span> @enderror
                            </div>
                            ...
                            <div class="pt-4 flex items-center gap-3">
                                <button type="submit" wire:loading.attr="disabled" class="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-md shadow-sm transition">
                                    <span wire:loading.remove wire:target="save">{{ $isEditing ? 'Update Expense' : 'Save Expense' }}</span>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                        <div class="p-4 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
                            ...
                            <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search expenses..." class="rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-1">
                        </div>
                                        ...
                                        <tr class="hover:bg-gray-50 transition">
                                            ...
                                            <td class="px-6 py-4">
                                                ...
                                                <p class="text-xs font-medium text-gray-500 mt-0.5">
                                                    <span class="bg-gray-100 px-2 py-0.5 rounded text-gray-600">{{ $expense->category }}</span>
                                                </p>
                                            </td>
